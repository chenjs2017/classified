					...
					if($loop->post_count > 0){
						...
						$post_id = get_the_id();
                            ...
                            if ($pfgrid == 'grid1') {
                                ...
                                $wpflistdata_output .= '<li class="col-lg-12 col-md-12 col-sm-12 col-xs-12  isotope-item">';
                                $wpflistdata_output .= '<div class="pflist-item" style="background-color:#ffffff;">';
                                $wpflistdata_output .= '<div class="pflist-item-inner">';
                                $wpflistdata_output .= '
														<div class="pflist-detailcontainer ">
															<ul class="pflist-itemdetails">
																<li class="pflist-itemtitle">'.get_the_time("Y-m-d").' <a href="' . $ItemDetailArr['if_link'] . '"' . $targetforitem . '>' . $title_text . '</a></li>
																</ul></div>';
