						...
						<div class="col-lg-9 col-md-9" id="pfmenucol1">
							<div class="pf-menu-container">
								...
								<nav id="pf-primary-nav" class="pf-nav-dropdown clearfix">
									<ul class="pf-nav-dropdown pfnavmenu pf-topnavmenu">
										<li class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom menu-link main-menu-link">
											<br>
											<form method="get" action="http://<?php echo $_SERVER['SERVER_NAME'];?>/" data-ajax="false">
											<label class="lbl-ui pflabelfixsearch pflabelfixsearchsearchkey">
												<input  name="jobskeyword" id="searchkey" type="text" size=15 value="<?php echo $_REQUEST['jobskeyword'];?>" placeholder="搜索" autocomplete="off" />
											...
											<script type="text/javascript">
												(function($) {
													...
													$(function(){
														...
														$( "#searchkey" ).bind("keydown",function(){


															$( "#searchkey" ).autocomplete({
																appendTo: ".pflabelfixsearchsearchkey",
										...
										<div class="postanitem-inner">
											<span class="pfadmicon-glyph-478"></span>登录
										</div>
										</a>
										</li>
