...
if ($_GET['jobskeyword']<>'') {
    ...
    $new_url="?field693857424829123400000=".$term->term_id."&pointfinder_radius_search=".$_GET['pointfinder_radius_search']."&field296725954161956900000=".$location."&ne=&ne2=&sw=&sw2=&s=&serialized=1&action=pfs";
		...
		**/
			...
			if(is_array($pfgetdata)){
				...
				$pfformvars = array();
					...
					if ($_GET['field296725954161956900000']<>'')
					{
